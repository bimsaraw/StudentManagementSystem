...
if (isset($_POST['submit'])) {
       ...
       if($conn->query($validateId)->num_rows>0){
            ...
            $insert = "INSERT INTO student (studentId, Name, Address, City, Country, Email, Telephone, Mobile, Image, Guardian, Guardian_TP, Education, Date_added)
                VALUES ('$studentId','$name','$address','$city','$country','$email','$telephone','$mobile','$image','$guardian','$guardian_TP','$education','$date_added')";
                        ...
                        <div class="insideholder">
                            ...
                            <form class="form-horizontal" method="post" action="">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="telephone" name="telephone" value="<?php echo $_POST['telephone']; ?>" placeholder="Enter the telephone number with coutry code" maxlength="14" data-fv-numeric="true" data-fv-numeric-message="Please enter valid phone number" required>
                                    </div>
                                </div>    
                                <div class="form-group">
                                    <label class="control-label col-sm-2" for="mobile">Mobile:</label>
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="mobile" name="mobile" value="<?php echo $_POST['mobile']; ?>" placeholder="Enter mobile number with coutry code" required>
                                    </div>
                                </div>    
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="guardian_TP" name="guardian_TP" value="<?php echo $_POST['guardian_TP']; ?>" placeholder="Enter Mother/Father or Guardian's contact no." required>
                                    </div>
                                </div> 
                                <div class="form-group">
